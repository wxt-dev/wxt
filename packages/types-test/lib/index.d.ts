...
/// <reference path="./browser-cast/index.d.ts" />
...
declare namespace browser {
  ...
  export namespace dom {
    /**
     * @since Chrome 88
     * Requests browser to return the open/closed shadow roots else return null.
  ...
  export namespace declarativeNetRequest {
    ...
    export interface URLTransform {
       ...
       * Allowed values are "http", "https", "ftp" and "browser-extension".
       */
      scheme?: string | undefined;
