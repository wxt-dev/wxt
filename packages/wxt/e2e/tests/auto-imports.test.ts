    ...
    it('should generate a declaration file, imports.d.ts, for auto-imports', async () => {
      ...
      expect(await project.serializeFile('.wxt/types/imports.d.ts'))
        .toMatchInlineSnapshot(`
          ...
          export {}
          declare global {
            const ContentScriptContext: typeof import('wxt/utils/content-scripts-context')['ContentScriptContext']
      ...
      expect(await project.serializeFile('.wxt/types/imports-module.d.ts'))
        .toMatchInlineSnapshot(`
          ...
          declare module '#imports' {
            ...
            export { ContentScriptContext } from 'wxt/utils/content-scripts-context';
            ...
            export { MatchPattern, InvalidMatchPattern } from 'wxt/utils/match-patterns';
