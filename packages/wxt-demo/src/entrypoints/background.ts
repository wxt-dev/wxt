export default defineBackground({
  ...
  main() {
    ...
    console.log(i18n.t('prompt_for_name'));
    console.log(i18n.t('hello', ['test']));
    console.log(i18n.t('bye', ['Aaron']));
    console.log(i18n.t('@@extension_id'));
    console.log(i18n.t('deep.example'));
