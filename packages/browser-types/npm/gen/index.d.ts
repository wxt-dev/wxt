...
declare namespace browser {
  ...
  export namespace accessibilityFeatures {
    ...
    export var spokenFeedback: browser.types.ChromeSetting;
    /** **ChromeOS only.** Enlarged cursor. */
    export var largeCursor: browser.types.ChromeSetting;
    /** **ChromeOS only.** Sticky modifier keys (like shift or alt). */
    export var stickyKeys: browser.types.ChromeSetting;
    /** **ChromeOS only.** High contrast rendering mode. */
    export var highContrast: browser.types.ChromeSetting;
    /** **ChromeOS only.** Full screen magnification. */
    export var screenMagnifier: browser.types.ChromeSetting;
    /** **ChromeOS only.** Auto mouse click after mouse stops moving. */
    export var autoclick: browser.types.ChromeSetting;
    /** **ChromeOS only.** Virtual on-screen keyboard. */
    export var virtualKeyboard: browser.types.ChromeSetting;
    /**
     * **ChromeOS only.**
     * Caret highlighting.
     * @since Chrome 51
     */
    export var caretHighlight: browser.types.ChromeSetting;
    /**
     * **ChromeOS only.**
     * Cursor highlighting.
     * @since Chrome 51
     */
    export var cursorHighlight: browser.types.ChromeSetting;
    /**
     * **ChromeOS only.**
     * Focus highlighting.
     * @since Chrome 51
     */
    export var focusHighlight: browser.types.ChromeSetting;
    /**
     * **ChromeOS only.**
     * Select-to-speak.
     * @since Chrome 51
     */
    export var selectToSpeak: browser.types.ChromeSetting;
    /**
     * **ChromeOS only.**
     * Switch Access.
     * @since Chrome 51
     */
    export var switchAccess: browser.types.ChromeSetting;
    /**
     * @since Chrome 42
     */
    export var animationPolicy: browser.types.ChromeSetting;
  }
  ...
  export namespace action {
    ...
    export interface BrowserClickedEvent
      extends browser.events.Event<(tab: browser.tabs.Tab) => void> {}
  ...
  export namespace alarms {
    ...
    export interface AlarmEvent
      extends browser.events.Event<(alarm: Alarm) => void> {}
  ...
  ////////////////////
  /**
   * The browser.audio API is provided to allow users to get information about and control the audio devices attached to the system.
  ...
  export namespace audio {
     ...
     */
    export const onDeviceListChanged: browser.events.Event<
     ...
     */
    export const onLevelChanged: browser.events.Event<
     ...
     */
    export const onMuteChanged: browser.events.Event<
  ...
  export namespace commands {
    ...
    export interface CommandEvent
      extends browser.events.Event<
        (command: string, tab: browser.tabs.Tab) => void
      > {}
  ...
  export namespace cookies {
    ...
    export interface CookieChangedEvent
      extends browser.events.Event<(changeInfo: CookieChangeInfo) => void> {}
    ...
    export function remove(
      ...
      callback?: (details: CookieDetails) => void,
    ): void;
    /**
  ...
  export namespace devtools.inspectedWindow {
    ...
    export interface ResourceAddedEvent
      extends browser.events.Event<(resource: Resource) => void> {}
  ...
  export namespace devtools.network {
    ...
    export interface RequestFinishedEvent
      extends browser.events.Event<(request: Request) => void> {}

    export interface NavigatedEvent
      extends browser.events.Event<(url: string) => void> {}
  ...
  ////////////////////
  /**
   * The browser.devtools.performance API allows developers to interact with the recording features of the Performance panel in Chrome DevTools. You can use this API to get notifications when recording starts or stops.
   * @since Chrome 128
   */
  export namespace devtools.performance {
    ...
    export interface ProfilingStoppedEvent
      extends browser.events.Event<() => void> {}
  ...
  export namespace devtools.panels {
    export interface PanelShownEvent
      extends browser.events.Event<(window: Window) => void> {}
  ...
  ////////////////////
  /**
   * Use the browser.dom API to programmatically access shadow root in an HTMLElement.
   * @since Chrome 88
   */
  ...
  export namespace downloads {
    ...
    export interface DownloadChangedEvent
      extends browser.events.Event<(downloadDelta: DownloadDelta) => void> {}

    export interface DownloadCreatedEvent
      extends browser.events.Event<(downloadItem: DownloadItem) => void> {}

    export interface DownloadErasedEvent
      extends browser.events.Event<(downloadId: number) => void> {}
  ...
  export namespace enterprise.hardwarePlatform {
    ...
    export function getHardwarePlatformInfo(
      callback: (info: HardwarePlatformInfo) => void,
    ): void;
  }
  ...
  ////////////////////
  /**
   * Use the <code>browser.enterprise.networkingAttributes</code> API to read information about your current network. Note: This API is only available to extensions force-installed by enterprise policy.
   * Important: This API works only on Chrome OS.
   * @since Chrome 85
   */
  ...
  export namespace gcm {
    ...
    export interface MessageReceptionEvent
      extends browser.events.Event<(message: IncomingMessage) => void> {}

    export interface MessageDeletionEvent
      extends browser.events.Event<() => void> {}

    export interface GcmErrorEvent
      extends browser.events.Event<(error: GcmError) => void> {}
  ...
  export namespace history {
    ...
    export interface HistoryVisitedEvent
      extends browser.events.Event<(result: HistoryItem) => void> {}

    export interface HistoryVisitRemovedEvent
      extends browser.events.Event<(removed: RemovedResult) => void> {}
  ...
  export namespace idle {
    ...
    export interface IdleStateChangedEvent
      extends browser.events.Event<(newState: IdleState) => void> {}
  ...
  export namespace input.ime {
    ...
    export interface BlurEvent
      extends browser.events.Event<(contextID: number) => void> {}
    ...
    export interface DeactivatedEvent
      extends browser.events.Event<(engineID: string) => void> {}

    export interface InputContextUpdateEvent
      extends browser.events.Event<(context: InputContext) => void> {}
    ...
    export interface MenuItemActivatedEvent
      extends browser.events.Event<(engineID: string, name: string) => void> {}
  ...
  export namespace loginState {
    export interface SessionStateChangedEvent
      extends browser.events.Event<(sessionState: SessionState) => void> {}
  ...
  export namespace management {
    ...
    export interface ManagementDisabledEvent
      extends browser.events.Event<(info: ExtensionInfo) => void> {}

    export interface ManagementUninstalledEvent
      extends browser.events.Event<(id: string) => void> {}
  ...
  export namespace networking.config {
    ...
    export interface CaptivePorttalDetectedEvent
      extends browser.events.Event<(networkInfo: NetworkInfo) => void> {}
  ...
  export namespace notifications {
    ...
    export interface NotificationClickedEvent
      extends browser.events.Event<(notificationId: string) => void> {}
    ...
    export interface NotificationPermissionLevelChangedEvent
      extends browser.events.Event<(level: string) => void> {}
  ...
  export namespace omnibox {
    ...
    export interface OmniboxSuggestionDeletedEvent
      extends browser.events.Event<(text: string) => void> {}
 ...
 */
  export namespace printing {
    ...
    export function getPrinterInfo(
      printerId: string,
      callback: (response: GetPrinterInfoResponse) => void,
    ): void;
  ...
  export namespace privacy {
    export interface Services {
      ...
      /** @since Chrome 70 */
      autofillAddressEnabled: browser.types.ChromeSetting;
      /** @since Chrome 70 */
      autofillCreditCardEnabled: browser.types.ChromeSetting;
    }
    ...
    export interface Network {
      ...
      /** @since Chrome 48 */
      webRTCIPHandlingPolicy: browser.types.ChromeSetting;
    }
    ...
    export interface Websites {
      ...
      /** @since Chrome 65 */
      doNotTrackEnabled: browser.types.ChromeSetting;
    }
  ...
  export namespace proxy {
    ...
    export interface ProxyErrorEvent
      extends browser.events.Event<(details: ErrorDetails) => void> {}
      ...
      event_rules?:
        | Array<{
            ...
            actions?:
              ...
              | undefined;
            conditions?:
              | browser.declarativeContent.PageStateMatcherProperties[]
              | undefined;
          }>
        | undefined;
  ...
  export namespace system.storage {
    ...
    export interface SystemStorageAttachedEvent
      extends browser.events.Event<(info: StorageUnitInfo) => void> {}
  ...
  export namespace tabCapture {
    ...
    export interface CaptureStatusChangedEvent
      extends browser.events.Event<(info: CaptureInfo) => void> {}
  ...
  export namespace tabs {
    ...
    export interface TabHighlightedEvent
      extends browser.events.Event<(highlightInfo: TabHighlightInfo) => void> {}
    ...
    export interface TabCreatedEvent
      extends browser.events.Event<(tab: Tab) => void> {}

    export interface TabActivatedEvent
      extends browser.events.Event<(activeInfo: TabActiveInfo) => void> {}
    ...
    export interface TabZoomChangeEvent
      extends browser.events.Event<(ZoomChangeInfo: ZoomChangeInfo) => void> {}
  ...
  export namespace tabGroups {
    ...
    export interface TabGroupCreatedEvent
      extends browser.events.Event<(group: TabGroup) => void> {}
    ...
    export interface TtsEngineSpeakEvent
      extends browser.events.Event<
        (
          utterance: string,
          options: SpeakOptions,
          sendTtsEvent: (event: browser.tts.TtsEvent) => void,
        ) => void
      > {}
  ...
  export namespace types {
    ...
    export interface ChromeSettingChangedEvent
      extends browser.events.Event<DetailsCallback> {}
  ...
  export namespace vpnProvider {
    ...
    export interface VpnPacketReceptionEvent
      extends browser.events.Event<(data: ArrayBuffer) => void> {}
    ...
    export interface VpnUiEvent
      extends browser.events.Event<(event: string, id?: string) => void> {}
  ...
  export namespace webRequest {
    ...
    export interface WebRequestBodyEvent
      extends browser.events.EventWithRequiredFilterInAddListener<
  ...
  export namespace webstore {
    ...
    export interface InstallationStageEvent
      extends browser.events.Event<(stage: string) => void> {}

    export interface DownloadProgressEvent
      extends browser.events.Event<(percentDownloaded: number) => void> {}
  ...
  export namespace windows {
    ...
    export interface WindowIdEvent
      extends browser.events.Event<(windowId: number) => void> {
      addListener(
     ...
     */
    export function getAll(
      callback: (windows: browser.windows.Window[]) => void,
    ): void;
    /**
     * Gets all windows.
     * @return The `getAll` method provides its result via callback or returned as a `Promise` (MV3 only).
  ...
  export namespace declarativeNetRequest {
    ...
    export interface RuleMatchedDebugEvent
      extends browser.events.Event<(info: MatchedRuleInfoDebug) => void> {}
   ...
   * https://developer.browser.com/docs/extensions/reference/api/sidePanel
  ...
  // Type definitions for browser.userScripts API

  /**
   * Availability: Chrome 120 beta. Manifest v3.
   * https://developer.browser.com/docs/extensions/reference/api/userScripts
