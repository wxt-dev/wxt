...
export namespace Browser {
  ...
  export namespace accessibilityFeatures {
    ...
    export const animationPolicy: Browser.types.ChromeSetting<
      'allowed' | 'once' | 'none'
    >;
  ...
  export namespace action {
    ...
    export const onClicked: Browser.events.Event<
     ...
     * @since Chrome 130
     */
    export const onUserSettingsChanged: Browser.events.Event<
  ...
  export namespace contentSettings {
    ...
    export interface ContentSetting<T extends string> {
       ...
       */
      get(
        details: ContentSettingGetParams,
      ): Promise<ContentSettingGetResult<T>>;
      get(
        details: ContentSettingGetParams,
        callback: (details: ContentSettingGetResult<T>) => void,
      ): void;
  ...
  export namespace _debugger {
    ...
    export const onDetach: Browser.events.Event<
      (source: Debuggee, reason: `${DetachReason}`) => void
    >;
    /** Fired whenever debugging target issues instrumentation event. */
    export const onEvent: Browser.events.Event<
  ...
  export namespace documentScan {
     ...
     * @since Chrome 125
     */
    export function cancelScan<T = string>(
      job: T,
    ): Promise<CancelScanResponse<T>>;
    export function cancelScan<T = string>(
      job: T,
      callback: (response: CancelScanResponse<T>) => void,
    ): void;
    ...
    export function closeScanner<T = string>(
      scannerHandle: T,
    ): Promise<CloseScannerResponse<T>>;
    export function closeScanner<T = string>(
      scannerHandle: T,
    ...
    export function getOptionGroups<T = string>(
      scannerHandle: T,
    ): Promise<GetOptionGroupsResponse<T>>;
    export function getOptionGroups<T = string>(
      scannerHandle: T,
     ...
     * @since Chrome 125
     */
    export function readScanData<T = string>(
      job: T,
    ): Promise<ReadScanDataResponse<T>>;
    export function readScanData<T = string>(
      job: T,
      callback: (response: ReadScanDataResponse<T>) => void,
    ): void;
    ...
    export function scan(
      options: ScanOptions,
      callback: (result: ScanResults) => void,
    ): void;
  ...
  export namespace identity {
    ...
    export const onSignInChanged: Browser.events.Event<
  ...
  export namespace permissions {
    ...
    export const onRemoved: Browser.events.Event<
      (permissions: Permissions) => void
    >;

    /** Fired when the extension acquires new permissions. */
    export const onAdded: Browser.events.Event<
      (permissions: Permissions) => void
    >;
  }
  ...
  export namespace readingList {
    ...
    export function query(
      info: QueryInfo,
      callback: (entries: ReadingListEntry[]) => void,
    ): void;
     ...
     * @since Chrome 120, MV3
     */
    export const onEntryAdded: Browser.events.Event<
     ...
     * @since Chrome 120, MV3
     */
    export const onEntryRemoved: Browser.events.Event<
      (entry: ReadingListEntry) => void
    >;
     ...
     * @since Chrome 120, MV3
     */
    export const onEntryUpdated: Browser.events.Event<
      (entry: ReadingListEntry) => void
    >;
  }
  ...
  export namespace ttsEngine {
     ...
     * @since Chrome 131
     */
    export const onInstallLanguageRequest: Browser.events.Event<
     ...
     * @since Chrome 132
     */
    export const onLanguageStatusRequest: Browser.events.Event<
      (requestor: TtsClient, lang: string) => void
    >;
  ...
  export namespace types {
     ...
     * @since Chrome 44
     */
    export type ChromeSettingScope =
      | 'regular'
      | 'regular_only'
    ...
    export interface ChromeSetting<T> {
      ...
      get(
        ...
        callback: (details: ChromeSettingGetResult<T>) => void,
      ): void;
      ...
      onChange: Browser.events.Event<
        (details: ChromeSettingOnChangeDetails<T>) => void
      >;
    }
  }
  ...
  export namespace webRequest {
    ...
    export type _WebResponseHeadersEvent<T extends WebResponseHeadersDetails> =
      WebRequestEvent<(details: T) => void, string[]>;
    ...
    export type WebResponseCacheEvent =
      _WebResponseHeadersEvent<WebResponseCacheDetails>;

    export type WebRedirectionResponseEvent =
      _WebResponseHeadersEvent<WebRedirectionResponseDetails>;
  ...
  export namespace userScripts {
    ...
    export function getWorldConfigurations(
      callback: (worlds: WorldProperties[]) => void,
    ): void;
